...
local function runSellSequence()
    ...
    pcall(function() RS.Msg.RemoteEvent.RemoteEvent:FireServer(str1, {str2, "10030100"}) end)
    task.wait(0.4)
    pcall(function() RS.Msg.RemoteEvent.RemoteEvent:FireServer(str1, {str2, 10030401}) end)
    task.wait(0.4)
    pcall(function() RS.Msg.Function.TalkFunc:InvokeServer(str3, {"SellPop"}) end)
    task.wait(0.4)
    pcall(function() RS.Msg.RemoteFunction.RemoteFunction:InvokeServer(str4, {["onlyIDList"] = {1137,1140,1139,1138}}) end)
    task.wait(0.4)
    pcall(function() RS.Msg.RemoteFunction.RemoteFunction:InvokeServer(str4, {["onlyIDList"] = {1014,1016,1013,1012,1011}}) end)
    task.wait(0.4)
    pcall(function() RS.Msg.RemoteEvent.RemoteEvent:FireServer(str5) end)
end
